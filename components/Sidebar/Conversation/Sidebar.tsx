  ...
  return (
    ...
    >
      <header className="mt-5 flex items-center justify-center">
        <button
          className="flex w-[190px] flex-shrink-0 cursor-pointer select-none items-center justify-center gap-3 rounded-md border border-white/20 bg-black p-3 text-center text-[12.5px] leading-3 text-white transition-colors duration-200 hover:bg-bgPrimary"
          // bg-primary
          onClick={() => {
            onNewConversation();
            setSearchTerm('');
